...
In order to provide realistic radiative forcing estimates and projections, it is important for the atmospheric models to be able to capture the aerosol trends caused by both natural and anthropogenic variations. 

Model evaluation is one of the main focus of the AeroCom project. Specific experiments are conducted, within this project, for evaluating some aerosol species, like dust \citep{Huneeus-acp-2011} or organic aerosols \cite{Tsigaridis-acp-2014}. AeroCom global intercomparison and evaluation studies are assessing the overall performances of the models for simulating the aerosols optical properties \citep{kinne-acp-2006,jonaseval}, but are usually focusing on a single year.

With a consistent multi-parameter analysis, this study presents an overview of the aerosol trends, over the last two decades, using ground based observation network data as a reference for the evaluation of the models skills in reproducing those trends.
...
\subsubsection{\chem{SO_4} aerosol concentration}
