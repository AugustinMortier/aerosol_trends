...
\paragraph{Columnar measurements}
...
** USED IN THIS STUDY AERONET: level2.0 (quality assured), version 3** + remove outliers
\begin{itemize}
 \item AOD: od550aer - AeronetSun
 \item AE: ang4487aer - AeronetSun
 \item AOD<1µm: od550lt1aer - AeronetSDA
 \item AOD>1µm: od550lg1aer - AeronetSDA
\end{itemize}

\paragraph{Surface measurements}
...
\subparagraph{$SO_{4}$ concentration}
...
(See Jonas paper)
\begin{itemize}
 \item Scattering coefficient (\unit{Mm^{-1}}): dry -> RH<30\%? - Validity range: []
 \item Absorption coefficients (\unit{Mm^{-1}}): validity range: [] - Validity range: []
\end{itemize}
...
\begin{table}
 \begin{tabular}{llllllll}
  ...
  $PM_{2.5}$ (µg.m-3)     & 12.7   & 6.0      & -        & -       & -       & -    & -         \\
  $PM_{10}$ (µg.m-3)      & 16.8   & 11.5     & -        & 19.6    & -       & -    & -         \\
  $SO_{4}$ (µg.m-3)       & 2.01   & 1.45     & -        & 2.98    & -       & 1.97 & -         \\
...
\begin{table}
 \begin{tabular}{lll}
  ...
  $PM_{2.5}$ (µg m-3)     & (12.4) 9.1    & (+0.2) +0.2   \\
  $PM_{10}$ (µg m-3)      & (19.3) 18.7   & (+0.1) +0.1   \\
  $SO_{4}$ (µg m-3)       & (2.33) 0.64   & (-1.1) +0.4   \\
...
\begin{figure}[t]
 ...
 \caption{Absolute trends in OD and emissions of the main aerosol species computed with NorESM2. The y-axis of the trends in OD and the emissions }
...
\appendixfigures  %% needs to be added in front of appendix figuresglobal means and
