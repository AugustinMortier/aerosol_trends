...
The AOD is more than three times higher in Asia (0.35) than in North-America (0.10). Usually, the AOD is largely dominated by its fine fraction (AOD<1µm), but it is not the case in North-Africa, where the persistent presence of desert dust makes the coarse mode (AOD>1µm) as prevailing as the fine mode. This is also noticeable with the AE which is minimum in this region (0.72). 
