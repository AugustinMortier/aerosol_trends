...
Figure \ref{fig:hist_runs} presents the global modeled AOD between 1850 and 2014. All of the climate models seem to capture a large increase, especially between 1950 and 1990, predating more stable conditions. The aerosols optical measurements, which started to develop in the late 1990's, allow to investigate the trends over the last two decades, and offer an opportunity to validate the modeled trends in this period. With 2014 being the last year available from the CMIP6 historical runs, we focus this study on the 2000-2014 period.
...
\begin{table}
 \begin{tabularx}{\textwidth}{lllX}
  ...
  $PM_{2.5}$  & Surface & EMEP; IMPROVE                 & ECMWF-Rean;  NorESM2;  SPRINTARS;  ECHAM-HAM; GEOS                                                                                       \\
...
\begin{itemize}
 ...
 \item AE: the trends are usually relatively lower than for AOD in the respective regions. This feature is visible with both observations and models.
       ...
       \end{itemize}
 \item PM2.5: \textcolor{red}{to be updated with complete time series} since no PM observation is available after the year 2006 in North America, the trends are associated with large uncertainties which makes the validation more difficult in this region. However, when discarding these uncertainties, the trends seem to be well captured by NorESM2 and ECHAM-HAM. \textcolor{red}{CAMS rean will show up with complete PM time series}. Consistently with the observations, all the models highlight a decrease in Europe.
