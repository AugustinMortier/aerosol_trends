...
In order to compare consistently the trends observed for the different parameters, one focus on the relative trends, with the reference set to the year 2000, as the first year of the study period. The means for the year 2000 are reported in Table \ref{table:obs_2000mean} reveal a great inter region variability. 
