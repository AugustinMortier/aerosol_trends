...
Analogous to the surface \chem{PM_{10}} measurements, $\sigma_{sp}$ is higher in Europe (33 \unit{Mm^{-1}}) than in North America (25 \unit{Mm^{-1}}). The same feature is found for $\sigma_{ap}$ which also has higher values in Europe than North America.
...
\footnotesize
 \begin{tabularx}{\textwidth}{llllllX}
  ...
  NorESM2    & CMIP6     & D, SS, DMS, MSA, BVOC      & C: \chem{SO_2}, \chem{SO_4}, OC, BC                          & F           & 1.89x2.50                  & \cite{selandprep, kirkevag2018production}               \\
